...
#### Python Pricing Engine
    ...
    maturity_date = 1.0  
    total_paths = 500
    Z_standard = np.random.normal(size = total_paths) 

    ST = spot_price * np.exp((risk_free_rate - 0.5 * volatility**2) * maturity_date + volatility * np.sqrt(maturity_date)* Z_standard)  
